                ...
                return (
                    <button
                        ...
                        className={classNames(
                            options.className,
                            'w-full p-link flex align-items-center p-2 pl-4 text-color hover:surface-200 border-noround logout-item'
                        )}
                    >
    ...
    return (
        <div className="sidebar-container">
            <div className="sidebar-menu-container">
                <Menu model={items} className="w-full" style={{ flexGrow: 1 }} />
            </div>
